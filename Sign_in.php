...
<body style="background-color: rgb(20,138,163)">
	...
	<div id="floatL" style="margin-left: 350px;">
		...
		<form style="padding: 20px" action="client_registernation.server.php" method="post">
			...
			<div >Remember me</div>
			<div style="margin-top: 10px"><input style="background-color: rgb(20,138,163);font-size: 25px;border-radius: 5px" type="button" name="" value="Log in"></div>
			<br>
			<br>
			<div><hr></div>
