				...
				<div style="padding: 60px; margin-left:400px">
					...
					<div style="font-size: 18px">
						...
						<form action="Add_teacher_server.php" method="post">
						    <input style=" font-size: 20px;margin-left: 10px;margin-top: 10px;" type="text" name="" id="name" /><br/>
							<input style=" font-size: 20px;margin-left: 10px;margin-top: 10px;" type="text" name="" id="id" /><br/>
						    <input style=" font-size: 20px;margin-left: 10px;margin-top: 10px;" type="text" name="" id="pwd" /><br/>
							&nbsp;&nbsp;Day<select style="font-size: 15px;margin-left: 10px;margin-top: 18px" id="day">
								<option>DD</option>
								<option>1</option>
								<option>2</option>
								<option>3</option>
							...
							Month<select style="font-size: 15px;margin-left: 10px" id="month">
								<option>MM</option>
								<option>Jan</option>
								<option>Feb</option>
								<option>Mar</option>
							...
							year<select style="font-size: 15px;margin-left: 10px" id="year">
								<option>YYYY</option>
								<option>2000</option>
								<option>2001</option>
								<option>2002</option>
							...
							<br/>
							<input style=" font-size: 20px;margin-left: 10px;margin-top: 10px;" type="text" name="" id="gender" /><br/>
							<input style=" font-size: 20px;margin-left: 10px;margin-top: 10px;" type="text" name="" id="Email" /><br/>
							<br/>
